    ...
    >
      {items.map((item, idx) => (
        ...
        >
          ...
          <Card>
            <CardTitle imgUrl={item.imgUrl}>{item.title}</CardTitle>
...
export const CardTitle = ({
  ...
  return (
    <div className="flex justify-start md:gap-20 gap-14">
        <img src={imgUrl} alt="project icon" className="w-14 h-14 rounded-xl"/>
